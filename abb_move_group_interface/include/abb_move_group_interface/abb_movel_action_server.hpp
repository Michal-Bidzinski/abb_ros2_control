...
#ifndef ABB_MOVE_GROUP_INTERFACE__MOVEL_ACTION_SERVER_HPP_
#define ABB_MOVE_GROUP_INTERFACE__MOVEL_ACTION_SERVER_HPP_
...
public:
  ...
  explicit MoveLActionServer(const rclcpp::NodeOptions & options);
  ABB_MOVE_GROUP_INTERFACE_PUBLIC
  explicit MoveLActionServer(std::shared_ptr<moveit::planning_interface::MoveGroupInterface> move_group_interface_obj, std::string move_group_name, std::string urdf_file, const rclcpp::NodeOptions & options);
