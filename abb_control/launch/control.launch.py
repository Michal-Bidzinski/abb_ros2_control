...
def launch_setup(context, *args, **kwargs):
    ...
    move_group_interface = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
           get_package_share_directory('abb_move_group_interface'), 'launch'),
           '/action_server.launch.py']),
        launch_arguments={'runtime_config_package': runtime_config_package.perform(context),
                          "param_file": param_file.perform(context)}.items(),
        )
